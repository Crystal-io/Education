# PIN-UP Partners / Affiliate CRM — словарь терминов и сокращений

> **Назначение:** практический словарь для онбординга Business Analyst в домене affiliate marketing / iGaming и внутренней CRM партнёрской программы.  
> **Важно:** внутренние определения, формулы и статусы PIN-UP Partners могут отличаться. При расхождении приоритет имеют регламенты, UI CRM, договоры и правила расчётов компании.
...
| Термин | Значение |
|---|---|
| **Admin Panel / Admin** | Внутренний интерфейс сотрудников |
| **Partner Cabinet / Portal** | Внешний интерфейс партнёра |
...
# 18. Термины, вероятно релевантные структуре PIN-UP Partners

| Термин | Практический смысл |
|---|---|
| **PIN-UP Partners** | Партнёрская программа и соответствующий business unit |
| **Partner-facing Web / Partner Cabinet** | Внешняя часть для вебмастеров и affiliate-команд |
...
| **AffShop** | Loyalty/shop-контур для партнёров |
| **Pincoins** | Внутренняя loyalty-валюта партнёрской экосистемы |
| **Quest** | Задание партнёру с проверкой и вознаграждением |

---

# 19. Критические различия, которые нельзя смешивать
...
# 20. Рабочее правило для аналитика
